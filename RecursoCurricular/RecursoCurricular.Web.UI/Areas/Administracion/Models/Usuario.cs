...
{
    public class Usuario : RecursoCurricular.Membresia.Usuario
    {
        public RecursoCurricular.FindType FindType
        {
            get;
            set;
        }
        ...
        public class RolPersona : RecursoCurricular.Membresia.RolPersona
        {
