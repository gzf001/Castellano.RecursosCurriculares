...
namespace RecursoCurricular.Membresia
{
    public static class Account
    {
        ...
        public class Rol
        {
            ...
            public static string Asignar(List<RecursoCurricular.Membresia.Account.Rol> model)
            {
                try
                {
                    Guid personaId = model.Select<RecursoCurricular.Membresia.Account.Rol, Guid>(x => x.PersonaId).Distinct().Single();
                    ...
                    {
                        foreach (RecursoCurricular.Membresia.RolPersona rolPersona in RecursoCurricular.Membresia.RolPersona.GetAll(persona))
                        {
                            new RecursoCurricular.Membresia.RolPersona
                            {
                    ...
                    using (RecursoCurricular.Membresia.Context context = new RecursoCurricular.Membresia.Context())
                    {
                        foreach (RecursoCurricular.Membresia.Account.Rol rolPersona in model)
                        {
                            new RecursoCurricular.Membresia.RolPersona
                            {
                                RolId = rolPersona.RolId,
