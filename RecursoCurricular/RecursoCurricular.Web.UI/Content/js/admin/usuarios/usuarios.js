...
jQuery(document).ready(function () {
    ...
    $(document).on('click', 'a[typebutton=Edit]', function () {
        ...
        $.getJSON('/Administracion/Admin/GetUsuario/' + $(this).attr('data-value'), function (data) {
            ...
            $.getJSON('/RecursoCurricular/Ciudades?regionCodigo=' + data.Persona.RegionCodigo, function (ciudad) {

                loadSelect($('#ciudad'), ciudad, data.Persona.CiudadCodigo);
            });

            $.getJSON('/RecursoCurricular/Comunas/' + data.Persona.RegionCodigo + '/' + data.Persona.CiudadCodigo, function (comuna) {
