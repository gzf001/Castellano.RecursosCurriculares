...
function loadData(data, enabled) {
    ...
    $.getJSON('/RecursoCurricular/Ciudades?regionCodigo=' + data.RegionCodigo, function (ciudad) {
    ...
    $.getJSON('/RecursoCurricular/Comunas/' + data.RegionCodigo + '/' + data.CiudadCodigo, function (comuna) {
