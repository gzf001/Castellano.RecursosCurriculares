...
{
    public class UserController : RecursoCurricular.Web.Controller
    {
        [Authorize]
        [HttpGet]
        public ActionResult MisDatos()
        {
            RecursoCurricular.Membresia.Usuario usuario = this.CurrentUsuario;

            RecursoCurricular.Persona persona = usuario.Persona;

            RecursoCurricular.Web.UI.Areas.Administracion.Models.Persona model = new RecursoCurricular.Web.UI.Areas.Administracion.Models.Persona
            {
                Id = persona.Id,
                Run = persona.Run,
        ...
        [Authorize]
        [HttpPost]
        public ActionResult MisDatos(RecursoCurricular.Web.UI.Areas.Administracion.Models.Persona model)
        {
        ...
        [Authorize]
        [HttpPost]
        public ActionResult ChangePassword(RecursoCurricular.Web.UI.Areas.Administracion.Models.ChangePassword model)
        {
            if (!this.ModelState.IsValid)
            {
                return this.View(model);
            ...
            string password = RecursoCurricular.Membresia.Account.EncryptPassword(model.Password);
            ...
            RecursoCurricular.Membresia.Account.DoChangePassword(this.CurrentUsuario, model.Password1, model.Password2);
