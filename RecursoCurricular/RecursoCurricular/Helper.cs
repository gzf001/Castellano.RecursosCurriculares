...
namespace RecursoCurricular
{
	public static class Helper
	{
		public static void SendMail(string to, string subject, string body)
		{
			...
			//message.From = new MailAddress("applicationserver@iRecursoCurricular.cl");
			//message.To.Add(to);
			...
			//smtp.EnableSsl = true;
			//smtp.Credentials = new NetworkCredential("applicationserver@iRecursoCurricular.cl", "insignia", "");
			//smtp.Send(message);
		}
