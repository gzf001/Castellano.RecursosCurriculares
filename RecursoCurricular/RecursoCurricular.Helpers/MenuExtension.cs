...
namespace RecursoCurricular.Helpers
{
    public static class MenuExtension
    {
        public static MvcHtmlString Menu(this HtmlHelper helper, Guid usuarioId)
        {
            ...
            RecursoCurricular.Persona persona = usuario.Persona;
            ...
            {
                List<RecursoCurricular.Membresia.MenuItem> itemPadre = RecursoCurricular.Membresia.MenuItem.GetAll(aplicacion, aplicacion.Inicio);
                ...
                foreach (RecursoCurricular.Membresia.MenuItem menuItem in itemPadre)
                {
                    List<RecursoCurricular.Membresia.MenuItem> items = RecursoCurricular.Membresia.MenuItem.GetAll(menuItem);
        ...
        private static string MenuString(RecursoCurricular.Membresia.MenuItem menuItem)
        {
            string retorno = string.Empty;

            foreach (RecursoCurricular.Membresia.MenuItem m in RecursoCurricular.Membresia.MenuItem.GetAll(menuItem))
            {
                List<RecursoCurricular.Membresia.MenuItem> items = RecursoCurricular.Membresia.MenuItem.GetAll(m);
        ...
        public static MvcHtmlString MenuOrderable(this HtmlHelper helper, RecursoCurricular.Membresia.Aplicacion aplicacion, RecursoCurricular.Web.Controller controller)
        {
            ...
            List<RecursoCurricular.Membresia.MenuItem> lista = RecursoCurricular.Membresia.MenuItem.GetAll(aplicacion, aplicacion.Inicio);

            if (lista.Any())
            {
                foreach (RecursoCurricular.Membresia.MenuItem menuItem in lista)
                {
                    ...
                    t.InnerHtml += string.Format("<div>{0}{1}{2}</div>", RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(menuItem.Id, menuItem.MenuItemId, TypeButton.Add, controller),
                                                                         RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(menuItem.Id, menuItem.MenuItemId, TypeButton.Edit, controller),
                                                                         RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(menuItem.Id, menuItem.MenuItemId, TypeButton.Delete, controller));
            ...
            else
            {
                ...
                t.InnerHtml += string.Format("<div>{0}</div>", RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(aplicacion.Inicio.Id, aplicacion.Inicio.MenuItemId, TypeButton.Add, controller));
            }
        ...
        private static string MenuOrderable(RecursoCurricular.Membresia.MenuItem menuItem, RecursoCurricular.Web.Controller controller)
        {
            string retorno = string.Empty;
            ...
            foreach (RecursoCurricular.Membresia.MenuItem m in RecursoCurricular.Membresia.MenuItem.GetAll(menuItem))
            {
                ...
                if (items.Any())
                {
                    ...
                    retorno += string.Format("<div>{0}{1}{2}</div>", RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(m.Id, m.MenuItemId, TypeButton.Add, controller),
                                                                     RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(m.Id, m.MenuItemId, TypeButton.Edit, controller),
                                                                     RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(m.Id, m.MenuItemId, TypeButton.Delete, controller));
                ...
                else
                {
                    retorno += string.Format("<li class='dd-item' data-id='{0}'>", m.Id);
                    retorno += string.Format("<div class='dd-handle'>{0}</div>", m.Nombre);
                    retorno += string.Format("<div>{0}{1}</div>", RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(m.Id, m.MenuItemId, TypeButton.Edit, controller),
                                                                  RecursoCurricular.Helpers.ActionLinkExtension.ActionLinkCrudEmbedded(m.Id, m.MenuItemId, TypeButton.Delete, controller));
                    retorno += "</li>";
                }
            }
